...
class ZendR_Store_Cart_Item_Collection implements ArrayAccess, IteratorAggregate, Countable
{
    ...
    public function addItem($offset = null, ZendR_Store_Cart_Item $obj = null, $validate = true)
    {
        if ($offset === null) {
            if (method_exists($obj, 'getId')) {
                $offset = $obj->getId();
